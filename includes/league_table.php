<table class="table table-standings">
  ...
  <tbody class="table-standings-body">
    ...
    <tr>
      ...
      <td class="table-standings-club"> <a href="?club=man_city"><?php echo $clubs['man_city'][0]; ?></a> </td>
    ...
    <tr>
      ...
      <td class="table-standings-club"> <a href="?club=man_utd"><?php echo $clubs['man_utd'][0]; ?></a> </td>
      <td class="table-standings-matches-played">38</td>
    ...
    <tr>
      ...
      <td class="table-standings-club"> <a href="?club=crystal_palace"><?php echo $clubs['crystal_palace'][0]; ?></a> </td>
      <td class="table-standings-matches-played">38</td>
    ...
    <tr>
      ...
      <td class="table-standings-club"> <a href="?club=wba"><?php echo $clubs['wba'][0]; ?></a> </td>
      <td class="table-standings-matches-played">38</td>
